...
public class PowerLoomSelectionShapes implements Function<BlockPos, VoxelShape>
{
    public static final Function<BlockPos, VoxelShape> SHAPE_GETTER = new PowerLoomSelectionShapes();

    private PowerLoomSelectionShapes()
    {
    }
    ...
    public VoxelShape apply(BlockPos posInMultiblock)
    {
        ...
        return PowerLoomShapes.SHAPE_GETTER.apply(posInMultiblock);
    }
